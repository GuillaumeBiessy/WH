...
At the time of writing the WH package allows REML (the default), AIC, BIC and GCV criteria to be selected. The `optimize` function is used in the one-dimension case [see @brent1973optimize] and the `optim` function with the Nelder-Mead algorithm [see @nelder1965optim] in the two-dimension case. Both functions come from the stats package and perform adequate optimization in the absence of derivatives.
